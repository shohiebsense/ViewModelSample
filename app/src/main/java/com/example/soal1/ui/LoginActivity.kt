...
import com.example.soal1.ui.login.LoginViewModelFactory
...
class LoginActivity : BaseActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        preferences.setIp("192.168.1.3/phalconsatu/")
        ...
        if(preferences.getCachedUser() != null){
            Toast.makeText(this, "Cached Login ",Toast.LENGTH_LONG);
            startActivity(Intent(baseContext, MainActivity::class.java))
            finish()
        }
    }

    val loginListener = object : User.ResponseListener {
        override fun onSuccessResponse(user: User) {
            preferences.setLoggedInUser(user)
